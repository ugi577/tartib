...
//
// Sesi 22: nama hari kanonik ('Jumat', bukan "Jum'at"); `ke` pada daftarJam
// selalu berurutan & unik (kunci sel), `nomorSesi` = JP resmi; kolom `guru`
// hanya peran generik ("Guru PAI", "Musyrif Halaqah") — aplikasi publik tidak
// membawa nama orang.
...
export const PRESET_KBM_5_HARI: ModelJadwalKbm = {
  ...
  // `ke` = nomor baris berurutan (kunci sel), `nomorSesi` = JP resmi.
  daftarJam: [
    { ke: 1, nomorSesi: 1, label: '07:15 - 08:00' },
    { ke: 2, nomorSesi: 2, label: '08:00 - 08:45' },
    { ke: 3, nomorSesi: 3, label: '08:45 - 09:30' },
    { ke: 4, label: '09:30 - 10:00 (Istirahat Dhuha)', istirahat: true },
    { ke: 5, nomorSesi: 4, label: '10:00 - 10:45' },
    { ke: 6, nomorSesi: 5, label: '10:45 - 11:30' },
    { ke: 7, label: '11:30 - 12:45 (Ishoma)', istirahat: true },
    { ke: 8, nomorSesi: 6, label: '12:45 - 13:30' },
    { ke: 9, nomorSesi: 7, label: '13:30 - 14:15' },
    { ke: 10, nomorSesi: 8, label: '14:15 - 15:00' },
  ],
  daftarKelas: ['VII-A', 'VII-B', 'VIII-A', 'IX-A'],
  entri: [
    // Senin
    { id: '1', hari: 'Senin', jamKe: 1, kelas: 'VII-A', mapel: 'Upacara Bendera', guru: 'Wali Kelas VII-A' },
    { id: '2', hari: 'Senin', jamKe: 2, kelas: 'VII-A', mapel: 'Pendidikan Agama Islam', guru: 'Guru PAI' },
    { id: '3', hari: 'Senin', jamKe: 3, kelas: 'VII-A', mapel: 'Pendidikan Agama Islam', guru: 'Guru PAI' },
    { id: '4', hari: 'Senin', jamKe: 5, kelas: 'VII-A', mapel: 'Matematika', guru: 'Guru Matematika' },
    { id: '5', hari: 'Senin', jamKe: 6, kelas: 'VII-A', mapel: 'Matematika', guru: 'Guru Matematika' },
    { id: '6', hari: 'Senin', jamKe: 8, kelas: 'VII-A', mapel: 'Bahasa Indonesia', guru: 'Guru Bahasa Indonesia' },
    { id: '7', hari: 'Senin', jamKe: 9, kelas: 'VII-A', mapel: 'Bahasa Indonesia', guru: 'Guru Bahasa Indonesia' },
    { id: '8', hari: 'Senin', jamKe: 10, kelas: 'VII-A', mapel: 'Tahfidz Sore', guru: 'Musyrif Tahfidz' },

    // Selasa
    { id: '9', hari: 'Selasa', jamKe: 1, kelas: 'VII-A', mapel: 'IPA Terpadu', guru: 'Guru IPA' },
    { id: '10', hari: 'Selasa', jamKe: 2, kelas: 'VII-A', mapel: 'IPA Terpadu', guru: 'Guru IPA' },
    { id: '11', hari: 'Selasa', jamKe: 3, kelas: 'VII-A', mapel: 'Bahasa Arab', guru: 'Guru Bahasa Arab' },
    { id: '12', hari: 'Selasa', jamKe: 5, kelas: 'VII-A', mapel: 'Bahasa Arab', guru: 'Guru Bahasa Arab' },
    { id: '13', hari: 'Selasa', jamKe: 6, kelas: 'VII-A', mapel: 'Bahasa Inggris', guru: 'Guru Bahasa Inggris' },
    { id: '14', hari: 'Selasa', jamKe: 8, kelas: 'VII-A', mapel: 'Bahasa Inggris', guru: 'Guru Bahasa Inggris' },
    { id: '15', hari: 'Selasa', jamKe: 9, kelas: 'VII-A', mapel: 'IPS', guru: 'Guru IPS' },
    { id: '16', hari: 'Selasa', jamKe: 10, kelas: 'VII-A', mapel: 'Pramuka / Ekskul', guru: 'Tim Pembina' },
  ],
...
export const PRESET_KBM_6_HARI: ModelJadwalKbm = {
  ...
  daftarJam: [
    { ke: 1, nomorSesi: 1, label: '07:30 - 08:15' },
    { ke: 2, nomorSesi: 2, label: '08:15 - 09:00' },
    { ke: 3, nomorSesi: 3, label: '09:00 - 09:45' },
    { ke: 4, label: '09:45 - 10:15 (Istirahat)', istirahat: true },
    { ke: 5, nomorSesi: 4, label: '10:15 - 11:00' },
    { ke: 6, nomorSesi: 5, label: '11:00 - 11:45' },
    { ke: 7, nomorSesi: 6, label: '11:45 - 12:30' },
  ],
  daftarKelas: ['1 Diniyah (Ula)', '2 Diniyah (Wustha)', '3 Diniyah (Ulya)'],
  entri: [
    // Senin
    { id: '101', hari: 'Senin', jamKe: 1, kelas: '1 Diniyah (Ula)', mapel: 'Nahwu Jurumiyyah', guru: 'Pengampu Nahwu' },
    { id: '102', hari: 'Senin', jamKe: 2, kelas: '1 Diniyah (Ula)', mapel: 'Nahwu Jurumiyyah', guru: 'Pengampu Nahwu' },
    { id: '103', hari: 'Senin', jamKe: 3, kelas: '1 Diniyah (Ula)', mapel: 'Shorof Amtsilah', guru: 'Pengampu Shorof' },
    { id: '104', hari: 'Senin', jamKe: 5, kelas: '1 Diniyah (Ula)', mapel: 'Fiqih Fathul Qorib', guru: 'Pengasuh Pondok' },
    { id: '105', hari: 'Senin', jamKe: 6, kelas: '1 Diniyah (Ula)', mapel: 'Aqidah Sanusiyyah', guru: 'Pengampu Aqidah' },
    { id: '106', hari: 'Senin', jamKe: 7, kelas: '1 Diniyah (Ula)', mapel: 'Hadits Arbain Nawawi', guru: 'Pengampu Hadits' },

    // Selasa
    { id: '107', hari: 'Selasa', jamKe: 1, kelas: '1 Diniyah (Ula)', mapel: 'Tarikh Islam', guru: 'Pengampu Tarikh' },
    { id: '108', hari: 'Selasa', jamKe: 2, kelas: '1 Diniyah (Ula)', mapel: 'Tajwid Tuhfatul Athfal', guru: 'Pengampu Tajwid' },
    { id: '109', hari: 'Selasa', jamKe: 3, kelas: '1 Diniyah (Ula)', mapel: 'Matematika Dasar', guru: 'Guru Matematika' },
    { id: '110', hari: 'Selasa', jamKe: 5, kelas: '1 Diniyah (Ula)', mapel: 'Bahasa Indonesia', guru: 'Guru Bahasa Indonesia' },
    { id: '111', hari: 'Selasa', jamKe: 6, kelas: '1 Diniyah (Ula)', mapel: 'Bahasa Arab (Insya)', guru: 'Pengampu Bahasa Arab' },
    { id: '112', hari: 'Selasa', jamKe: 7, kelas: '1 Diniyah (Ula)', mapel: 'Khath / Imla', guru: 'Pengampu Khath' },
  ],
  dibuatPada: new Date().toISOString(),
};
...
export const PRESET_KBM_ROSTER_TAHFIDZ: ModelJadwalKbm = {
  ...
  daftarHari: ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'],
  daftarJam: [
    { ke: 1, nomorSesi: 1, label: '05:15 - 06:45 (Sesi 1: Setoran Ziyadah Baru)' },
    { ke: 2, nomorSesi: 2, label: '16:00 - 17:30 (Sesi 2: Muroja’ah Sab’i / Dekat)' },
    { ke: 3, nomorSesi: 3, label: '18:30 - 20:00 (Sesi 3: Tasmi’ Juz & Mutqin)' },
  ],
  daftarKelas: ['Halaqah Ula (Juz 1-5)', 'Halaqah Wustha (Juz 6-15)', 'Halaqah Mutqinin (Juz 16-30)'],
  entri: [
    { id: '201', hari: 'Senin', jamKe: 1, kelas: 'Halaqah Ula (Juz 1-5)', mapel: 'Ziyadah 1/2 Halaman', guru: 'Musyrif Halaqah Ula' },
    { id: '202', hari: 'Senin', jamKe: 2, kelas: 'Halaqah Ula (Juz 1-5)', mapel: 'Muroja’ah 1/4 Juz', guru: 'Musyrif Halaqah Ula' },
    { id: '203', hari: 'Senin', jamKe: 3, kelas: 'Halaqah Ula (Juz 1-5)', mapel: 'Tasmi’ Berpasangan', guru: 'Musyrif Halaqah Ula' },

    { id: '204', hari: 'Senin', jamKe: 1, kelas: 'Halaqah Wustha (Juz 6-15)', mapel: 'Ziyadah 1 Halaman Penuh', guru: 'Musyrif Halaqah Wustha' },
    { id: '205', hari: 'Senin', jamKe: 2, kelas: 'Halaqah Wustha (Juz 6-15)', mapel: 'Muroja’ah 1/2 Juz', guru: 'Musyrif Halaqah Wustha' },
    { id: '206', hari: 'Senin', jamKe: 3, kelas: 'Halaqah Wustha (Juz 6-15)', mapel: 'Uji Hafalan Pekanan', guru: 'Tim Penguji Tahfidz' },

    { id: '207', hari: 'Senin', jamKe: 1, kelas: 'Halaqah Mutqinin (Juz 16-30)', mapel: 'Ziyadah & Qira’at', guru: 'Pengasuh Tahfidz' },
    { id: '208', hari: 'Senin', jamKe: 2, kelas: 'Halaqah Mutqinin (Juz 16-30)', mapel: 'Muroja’ah 1 Juz Bil-Ghaib', guru: 'Musyrif Halaqah Mutqinin' },
    { id: '209', hari: 'Senin', jamKe: 3, kelas: 'Halaqah Mutqinin (Juz 16-30)', mapel: 'Kajian Kaidah Tajwid Jazariyyah', guru: 'Pengasuh Tahfidz' },
  ],
  dibuatPada: new Date().toISOString(),
};
...
export const PRESET_KBM_PESANTREN_2026_2027: ModelJadwalKbm = {
  ...
  entri: [
    ...
    { id: 'p1-jum', hari: 'Jumat', jamKe: 1, kelas: 'Semua Santri / Halaqah', mapel: 'Qiyamullail berjamaah, Infirodi', warna: 'kuning' },
    ...
    { id: 'p2-jum', hari: 'Jumat', jamKe: 2, kelas: 'Semua Santri / Halaqah', mapel: 'Surah Thoha, Muzzammil, Istigfar dan doa fajr' },
    ...
    { id: 'p3-jum', hari: 'Jumat', jamKe: 3, kelas: 'Semua Santri / Halaqah', mapel: 'Shalat Subuh, Dzikir Pagi', warna: 'hijau' },
    ...
    { id: 'p4-jum', hari: 'Jumat', jamKe: 4, kelas: 'Semua Santri / Halaqah', mapel: 'TAKLIM / TARBIYAH', warna: 'kuning' },
    ...
    { id: 'p5-jum', hari: 'Jumat', jamKe: 5, kelas: 'Semua Santri / Halaqah', mapel: 'MAJELIS SHOLAWAT BURDAH', warna: 'kuning' },
    ...
    { id: 'p6-jum', hari: 'Jumat', jamKe: 6, kelas: 'Semua Santri / Halaqah', mapel: 'KEBERSIHAN UMUM' },
    ...
    { id: 'p7-jum', hari: 'Jumat', jamKe: 7, kelas: 'Semua Santri / Halaqah', mapel: 'KEBERSIHAN UMUM' },
    ...
    { id: 'p8-jum', hari: 'Jumat', jamKe: 8, kelas: 'Semua Santri / Halaqah', mapel: 'QOILULAH DAN MEMPERHATIKAN SUNNAH-SUNNAH HARI JUMAT', warna: 'hijau' },
    ...
    { id: 'p9-jum', hari: 'Jumat', jamKe: 9, kelas: 'Semua Santri / Halaqah', mapel: 'QOILULAH DAN MEMPERHATIKAN SUNNAH-SUNNAH HARI JUMAT', warna: 'hijau' },
    ...
    { id: 'p10-jum', hari: 'Jumat', jamKe: 10, kelas: 'Semua Santri / Halaqah', mapel: 'QOILULAH DAN MEMPERHATIKAN SUNNAH-SUNNAH HARI JUMAT', warna: 'hijau' },
    ...
    { id: 'p11-jum', hari: 'Jumat', jamKe: 11, kelas: 'Semua Santri / Halaqah', mapel: 'QOILULAH DAN MEMPERHATIKAN SUNNAH-SUNNAH HARI JUMAT', warna: 'hijau' },
    ...
    { id: 'p12-jum', hari: 'Jumat', jamKe: 12, kelas: 'Semua Santri / Halaqah', mapel: 'QOILULAH DAN MEMPERHATIKAN SUNNAH-SUNNAH HARI JUMAT', warna: 'hijau' },
    ...
    { id: 'p13-jum', hari: 'Jumat', jamKe: 13, kelas: 'Semua Santri / Halaqah', mapel: 'Sholat Ashar, Zikr Sore, Al Waqiah+Doa' },
    ...
    { id: 'p14-jum', hari: 'Jumat', jamKe: 14, kelas: 'Semua Santri / Halaqah', mapel: 'Infirodi / istirahat' },
    ...
    { id: 'p15-jum', hari: 'Jumat', jamKe: 15, kelas: 'Semua Santri / Halaqah', mapel: 'ZIKR PETANG, As-Sajdah, Al-Mulk & Ratib', warna: 'kuning' },
    ...
    { id: 'p16-jum', hari: 'Jumat', jamKe: 16, kelas: 'Semua Santri / Halaqah', mapel: 'Majelis Nazhoman Tuhfah, Aqidah dan Wasiyhat Ikhwan', warna: 'kuning' },
    ...
    { id: 'p17-jum', hari: 'Jumat', jamKe: 17, kelas: 'Semua Santri / Halaqah', mapel: 'MUSYAWARAH PEKANAN', warna: 'kuning' },
    ...
    { id: 'p18-jum', hari: 'Jumat', jamKe: 18, kelas: 'Semua Santri / Halaqah', mapel: 'Infirodi / istirahat' },
    ...
    { id: 'p19-jum', hari: 'Jumat', jamKe: 19, kelas: 'Semua Santri / Halaqah', mapel: 'Infirodi / istirahat' },
    ...
    { id: 'p20-jum', hari: 'Jumat', jamKe: 20, kelas: 'Semua Santri / Halaqah', mapel: 'Infirodi / istirahat' },
    ...
    { id: 'p21-jum', hari: 'Jumat', jamKe: 21, kelas: 'Semua Santri / Halaqah', mapel: 'WAJIB TIDUR MALAM', warna: 'abu' },
