...
- **Branch aktif:** `master` di tartib-app (lokal, riwayat penuh). Repo publik `ugi577/tartib`: branch `main` = snapshot bersih 59 file tanpa `docs/` (alur sinkron berikutnya belum diputuskan). Di repo v3: `batch-g-integrasi-v3` **dihapus** 2026-08-22; `batch-q1-bookmark-halaman` masih ada
