...
5. Setelah lulus: `./scripts/sync-publik.sh master --push` — snapshot publik berikutnya (saat ini repo publik masih `42429f3`; master kini juga memuat Sesi 17 — CI, ESLint, refactor TemplateView, pengingat cadangan — sehingga push pertama akan menyertakan semuanya; workflow CI aktif di repo publik sejak `.github/` ikut snapshot).
